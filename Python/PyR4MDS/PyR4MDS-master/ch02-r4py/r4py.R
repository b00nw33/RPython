...
diamonds_2 <- read_csv("./data/diamonds.csv")
...
# Importing, no header:
diamonds_base_nohead <- read.csv("./data/diamonds_noheader.csv", header = F)
...
# Importing, no header:
diamonds_base_nohead <- read_csv("./data/diamonds_noheader.csv")
names(diamonds_base_nohead)
